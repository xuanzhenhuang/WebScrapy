...
# 定义要抓取的网页列表
detail_links_all = ["https://www.ikea.com/us/en/cat/artificial-plants-flowers-20492/",
                    "https://www.ikea.com/us/en/cat/artificial-plants-flowers-20492/?page=2",
                    "https://www.ikea.com/us/en/cat/artificial-plants-flowers-20492/?page=3",
                    "https://www.ikea.com/us/en/cat/artificial-plants-flowers-20492/?page=4",
                    "https://www.ikea.com/us/en/cat/artificial-plants-flowers-20492/?page=5"]

co = ChromiumOptions().set_paths(browser_path=r'C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe')
# 新建页面对象
browser = ChromiumPage(co)
current_dir = os.path.dirname(os.path.abspath(__file__))
image_save_directory = os.path.join(current_dir, "images_IKEA_US")
data_file_path = os.path.join(current_dir, "productInfo_IKEA_US.xlsx")
...
print("数据已成功保存到 productInfo_IKEA_US.xlsx 文件中。")